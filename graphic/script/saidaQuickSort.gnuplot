...
set output 'graphic/quicksort.png'

# Título do gráfico
set title 'Análise empírica do algoritmo Quick Sort, em relação base de busca e tempo'
...
# Plotagem do gráfico
# Os dados a serem plotados constam no arquivo quicksort.dat
set grid
plot './data/estatistica/quicksort.dat' u 1:2  w l lw 2 t 'Melhor', '' u 1:3 t 'Médio' w l lw 2, '' u 1:4 t 'Pior' w l lw 2